          ...
          <div className="space-y-6">
            ...
            {subscription.status === "TRIAL" && (
              <Alert className="bg-blue-50 border-blue-200">
                ...
                <AlertDescription>
                  ...
                  necessário fornecer um método de pagamento para continuar
                  usando o sistema.
                </AlertDescription>
              </Alert>
            )}
            ...
            {subscription.status === "PAST_DUE" && (
              <Alert variant="destructive">
                ...
                <AlertDescription>
                  Sua última cobrança não foi processada. Por favor, atualize
                  seus dados de pagamento para evitar a suspensão do serviço.
                </AlertDescription>
              </Alert>
            )}
